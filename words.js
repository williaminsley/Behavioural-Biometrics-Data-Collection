...
export const WORDS = [
  ...
  "dirty","doubt","dosen","draft","drama","dream","dress","drift","drink","drive","drove","eager","early","earth","eight","elite","empty","enemy","enjoy","enter",
  ...
  "foundation","frequently","generation","geographic","governance","hypothesis","identities","independent","inequality","information","infrastructure","initialise",
...
export const BIGRAM_BOOST_WORDS = [
  "the","then","there","their","other","these","theme","think","three","thick",
  "when","where","whether","water","under","after","later","never","enter","order",
  "reason","ready","react","great","break","treat","bread","heard","heart","learn",
  "stand","stone","start","state","ended","under","hand","grand","sound","round",
  "angle","range","panel","planet","given","taken","often","open","alone","along",
  "fresh","press","green","screen","house","mouse","write","wrong","short","those"
];

export const TYPING_WORD_POOL = [
  ...WORDS,
  ...BIGRAM_BOOST_WORDS,
  ...BIGRAM_BOOST_WORDS,
  ...BIGRAM_BOOST_WORDS
